...
public class DonorProfile extends SQLiteOpenHelper {
    ...
    private static final String COL_ZIP_CODE = "phone_num";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String query = String.format("CREATE TABLE %s (%s INTEGER PRIMARY KEY AUTOINCREMENT, " +
                ...
                TABLE_NAME, COL_ID, COL_TYPE, COL_BUSINESS_NAME, COL_PHONE_NUM);
    ...
    void addData(String type, String email, String password_hash) {
        ...
        cv.put(COL_BUSINESS_NAME,email);
        cv.put(COL_PHONE_NUM,password_hash);
